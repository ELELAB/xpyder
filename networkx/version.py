...
version_info = ('networkx', 1, 6, '2049c85eac50')

# Format: a 'datetime.datetime' instance
date_info = datetime.datetime(2011, 11, 22, 7, 16, 0, 661186)

# Format: (vcs, vcs_tuple)
vcs_info = ('mercurial', ('2049c85eac50', 'tip'))
